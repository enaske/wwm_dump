...
Keys:
  ...
  S_SDK_CHECK_CANCEL: number
  AntiCheatSDKTypeFrame_1: string
  S_PREPARING: number
  S_SDK_CHECK_OK: number
  HMT_IOS_APP_CHANNEL: string
  AntiCheatSDKTypeNormal: string
  GLB_YY_ID: string
  UNISDK_JF_GAS3_URL: string
  ...
  SDK_LOGIN_OK: number
  AntiCheatSDKTypeFrame_2: string
  AntiCheatSDKTypeFrame_4: string
  MINOR_STATUS_ALLOW_ALL: number
  MINOR_STATUS_CHILD_NOT_CHECK: number
  MINOR_STATUS_CHILD_CHECK: number
  ACSDK_SECRETKEY: string
  JF_GAMEID: string
  JF_LOG_KEY: string
  JF_TEST_UNIPAY_URL: string
  LOGIN_IOS_CANCEL: number
  PC_PROP_MAP: table <UnknownInstance>
  JF_UNIPAY_SECRET: string
  ACSDK_HOST: string
  JF_PAY_LOG_URL: string