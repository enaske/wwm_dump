...
Keys:
  ...
  is_in_baicaoye: function()  -- patch/fenbao_consts.lua:63-75
  FENBAO_BTN_ICON_DOWNLOAD: string
  get_text_size: function(size)  -- patch/fenbao_consts.lua:77-84
  ...
  is_high2: function()  -- patch/fenbao_consts.lua:127-129
  FENBAO_DOWNLOAD_STATE_DOWNLOAD: number
  get_main_player_package_id: function()  -- patch/fenbao_consts.lua:105-118
  FENBAO_LOAD_STAGE_FINISH: number
  FENBAO_ICON_PAUSE: string
  FENBAO_PACKAGE_TYPE_VOICE: number
  is_fenbao_lang_in_use: function(package, package_type)  -- patch/fenbao_consts.lua:146-154
  get_fenbao_reward_text: function()  -- patch/fenbao_consts.lua:86-102
  ...
  need_fenbao_entry_visible: function()  -- patch/fenbao_consts.lua:120-122
  FENBAO_SUB_WAIGUAN_SIZE_DISPLAY_FACTORY: number
  FENBAO_LEVEL_MID: string
  SUB_FENBAO_DOWNLOADING: number
  use_high2_waiguan: function()  -- patch/fenbao_consts.lua:131-144
  show_tip: function(text_no, data)  -- patch/fenbao_consts.lua:156-164
  FENBAO_LEVEL_LOW: string
  show_confirm_window: function(text_no, data, cb)  -- patch/fenbao_consts.lua:166-183
