Module: hexm.common.consts.jieyi_consts
Type: table
================================================================================

Keys:
  JIEYI_TEAM_WTYPE: string
  ERR_OK: number
  ERR_JIEYI_TEAM_APLAY_LIMIT: number
  EVENT_JIEYI_CREATE_START: string
  EVENT_JIEYI_PRETEAM_QUIT_FORCE_NOTIFY: string
  JY_UNLOCK_ID: number
  ERR_JIEYI_TEAMS_FULL: number
  EVENT_JIEYI_UPDATE: string
  EVENT_JIEYI_ADD_FAVOR: string
  ERR_CD2: number
  ...
  EVENT_JIEYI_NOTIFY_CENTER: string
  ERR_HAS_JOIN_PRETEAM: number
  EVENT_JIEYI_START_PICTURE: string
  EVENT_JIEYI_PRETEAM_APPLY_CANCEL_NOTIFY: string
  EVENT_JIEYI_PRETEAM_QUIT: string
