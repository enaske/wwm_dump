Module: hexm.common.consts.affinity_consts
Type: table
================================================================================
...
Keys:
  ...
  AFFINITY_BENEFIT_ID_TRANSFER: number
  AFFINITY_SEND_GIFT: number
  ...
  AFFINITY_CHAT: number
  AFFINITY_SALOG_BENIFIT_ID: list
  AFFINITY_XIALV: number
  _reload_all: boolean
  AFFINITY_BENEFIT_TYPE_TRANSFER: number
  AFFINITY_BENEFIT_TYPE_FOLLOW: number
  AFFINITY_RCV_GIFT: number
  AFFINITY_BENEFIT_ID_SHRINK_FOLLOW: number
  AFFINITY_BENEFIT_TYPE_BADGE: number
  AFFINITY_BENEFIT_ID_CLOTHING_BORROW_3: number
  AFFINITY_BENEFIT_ID_ACTION: number
  ...
  AFFINITY_BENEFIT_ID_NOTIFY: number