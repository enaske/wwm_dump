...
Keys:
  ...
  Listenable: class <Listenable>
    Functions:
      ...
      dispatch_data(self, event, data)  -- hexm/client/util/listenable.lua:495-497
      ...
      scope_on_external(self, another_listenable, channel_name, scope_id)  -- hexm/client/util/listenable.lua:108-111
      ...
      listen_on_G_net_cb(self, event, closure)  -- hexm/client/util/listenable.lua:591-593
      ...
      listen_on_G_global_cb(self, event, closure)  -- hexm/client/util/listenable.lua:575-577
      scope_on_self_cue(self, scope_id)  -- hexm/client/util/listenable.lua:607-609
