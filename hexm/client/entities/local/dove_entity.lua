Module: hexm.client.entities.local.dove_entity
Type: table
================================================================================

Keys:
  DoveEntity: class <DoveEntity>
    Functions:
      ...
      detach(self)  -- hexm/client/entities/local/dove_entity.lua:103-106
      ...
      enter_space(self, ...)  -- hexm/client/entities/local/dove_entity.lua:63-73
