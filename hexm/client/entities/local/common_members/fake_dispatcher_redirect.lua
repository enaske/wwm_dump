Module: hexm.client.entities.local.common_members.fake_dispatcher_redirect
Type: table
================================================================================
...
Keys:
  ...
  FakeDispatcherRedirect: class <FakeDispatcherRedirect>
    Functions:
      _on_fake_interest_event(self, event, data)  -- hexm/client/entities/local/common_members/fake_dispatcher_redirect.lua:71-79
      ctor(...)  -- =[C]
