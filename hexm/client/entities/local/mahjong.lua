Module: hexm.client.entities.local.mahjong
Type: table
================================================================================

Keys:
  Mahjong: class <Mahjong>
    Functions:
      ...
      update_attach(self)  -- hexm/client/entities/local/mahjong_members/imp_tach.lua:62-66
      add_deactive(self)  -- hexm/client/entities/local/mahjong.lua:116-119
