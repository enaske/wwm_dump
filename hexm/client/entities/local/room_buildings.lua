...
Keys:
  RoomBuildings: class <RoomBuildings>
    Functions:
      ...
      blueprint_comp_check_is_prefilled(self)  -- hexm/client/entities/local/common_members/building_common/blueprint_comp_base.lua:133-143
      ...
      rigidbody_sub_rb_load_start(self, sub_id)  -- hexm/client/entities/local/room_buildings_members/imp_rigidbody.lua:49-52
      ...
      _update_billboard_visible_callback(self, entity, cb)  -- hexm/client/entities/local/common_members/billboard_base.lua:405-407
      ...
      blueprint_comp_get_grid_data(self)  -- hexm/client/entities/local/common_members/building_common/blueprint_comp_base.lua:94-96
