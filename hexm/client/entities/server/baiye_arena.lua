Module: hexm.client.entities.server.baiye_arena
Type: table
================================================================================

Keys:
  BaiyeArena: class <BaiyeArena>
    Functions:
      ...
      remove_local_entity(self)  -- hexm/client/entities/server/baiye_arena.lua:36-45
      ...
      on_base_update_event(self, event_key, data)  -- hexm/client/entities/server/common_members/setattr_base.lua:85-88
      on_leave_space(self)  -- hexm/client/entities/server/baiye_arena.lua:24-26
      on_enter_space(self)  -- hexm/client/entities/server/baiye_arena.lua:19-22
      ...
      on_base_clear_event(self, event_key, data)  -- hexm/client/entities/server/common_members/setattr_base.lua:90-93
      ...
      on_list_pop_event(self, event_key, data)  -- hexm/client/entities/server/common_members/setattr_base.lua:130-133
      on_bag_clear_event(self, event_key, data)  -- hexm/client/entities/server/common_members/setattr_base.lua:100-103
      create_local_entity(self)  -- hexm/client/entities/server/baiye_arena.lua:28-34
      ctor(self, kwargs)  -- hexm/client/entities/server/baiye_arena.lua:15-17
