Module: client.AsioServerProxy
Type: table
================================================================================

Keys:
  AsioServerProxy: class <AsioServerProxy>
    Functions:
      __index(self, rpc_name)  -- engine/client/AsioServerProxy.lua:34-42
      avatar_heart_bit(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      region_game_unload_batch(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      region_game_precess(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      ...
      rpc_mode_npc_change(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      rpc_request_active_interact_end(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      loading_completed(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      task_npc_act_sequence_finish(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      player_use_skill(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      ...
      rpc_speed_detect_latency(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      rpc_batch_send_rpc(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      rpc_time_sync_tz(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      rpc_debate_use_one_card(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      rpc_chase_task(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      rpc_batch_sync_to_others(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      rpc_space_region_effect_by_weather_client_space(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
      skill_reboot(self, ...)  -- engine/client/AsioServerProxy.lua:37-39
